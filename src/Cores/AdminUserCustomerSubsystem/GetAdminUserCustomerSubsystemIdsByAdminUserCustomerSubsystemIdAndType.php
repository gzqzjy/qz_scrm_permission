...
class GetAdminUserCustomerSubsystemIdsByAdminUserCustomerSubsystemIdAndType extends Core
{
    protected function execute()
    {
        ...
        $adminDepartmentIds = GetInfoByAdminUserCustomerSubsystemId::init()
    ...
    protected function getAdminUserCustomerSystemByTypeAndDepartment($type, $adminDepartmentIds)
    {
        switch ($type) {
            ...
            case AdminRoleRequest::THIS:
                $adminUserIds = AdminUserCustomerSubsystemDepartment::query()
                    ...
                    ->pluck('admin_user_customer_subsystem_id')
                    ->toArray();
     ...
     * @return GetAdminUserCustomerSubsystemIdsByAdminUserCustomerSubsystemIdAndType
     */
